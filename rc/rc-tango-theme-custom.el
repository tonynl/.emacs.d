...
(defvar cornsilk "#fff8dc")
(defvar honeydew "#f0fff0")
(defvar lightyellow "#ffffe0")
(defvar lightgoldenrodyellow "#fafad2")
(defvar mintcream "#f5fffa")
(defvar azure "#f0ffff")
...
(defun color-theme-tango-light ()
  ...
  (color-theme-install
   `(color-theme-tango-light
     ...
     (region ((t (:background ,lightgoldenrodyellow))))
     ...
     (font-lock-warning-face ((t (:bold t :foreground ,orange2))))
;;     (font-lock-function-name-face ((t (:foreground ,plum3 :bold t :italic t))))  ;;Ning
     (font-lock-function-name-face ((t (:foreground ,plum3 :bold t))))  ;;Ning
     (comint-highlight-input ((t (:italic t :bold t))))
     (comint-highlight-prompt ((t (:foreground ,choc1))))
